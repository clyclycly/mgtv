...
<script type="text/ecmascript-6">
  ...
  import MinTitle from 'components/min-title/min-title'
  import MediumTitle from 'components/medium-title/medium-title'
  import MgList from 'components/mg-list/mg-list'
  import Slider from 'base/slider/slider'
  import MortList from 'components/more-list/more-list'
  import MgStar from 'components/mg-star/mg-star'
